...
import { Menu, X, Home, Building, Calculator, PieChart, Settings, Moon, Sun } from "lucide-react";
        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <Link href="/" className="flex-shrink-0 flex items-center">
              <span className="text-xl font-bold text-blue-600 dark:text-blue-400">PropCalc</span>
            </Link>
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center">
            ...
            <div className="ml-3 relative">
              <div className="h-8 w-8 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
                <span className="text-xs font-medium text-gray-500 dark:text-gray-300">JD</span>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center px-4">
              <div className="flex-shrink-0">
                <div className="h-10 w-10 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
                  <span className="text-sm font-medium text-gray-500 dark:text-gray-300">JD</span>
                </div>
              </div>
              <div className="ml-3">
                <div className="text-base font-medium text-gray-800 dark:text-white">Jane Doe</div>
                <div className="text-sm font-medium text-gray-500 dark:text-gray-400">jane.doe@example.com</div>
              </div>
              <button
                onClick={toggleTheme}
