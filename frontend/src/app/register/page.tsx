        ...
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative">
                ...
                <div className="absolute bottom-0 left-0 p-12 text-white z-20">
                    ...
                    <h3 className="text-3xl font-bold mb-4">Manage Properties Efficiently</h3>
                    <p className="text-lg opacity-80 max-w-md">
                        Easily track your properties, maintenance requests, and income. Say goodbye to the hassle of manual management.
                    </p>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
                <div className="max-w-md w-full">
                    <div className="text-center mb-8">
                        <h1 className="text-3xl font-bold text-gray-900">Welcome to PropCalc</h1>
